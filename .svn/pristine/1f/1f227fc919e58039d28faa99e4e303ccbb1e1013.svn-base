...
var App = function () {
    ...
    var handleSidebarMenu = function () {
        ...
        jQuery('.page-sidebar-menu').find("li > a").each(function () {
            var path = $(this).attr("href");
            var pathindex = url.indexOf(path);
            if (pathindex != -1) {
                $(this).parent("li").addClass("active");
                if ($(this).parent("li").parent("ul").hasClass("sub-menu")) {
                    $(this).parent("li").parent("ul").css({ display: "block" }).parent("li").addClass("active open");
                    $(this).parent("li").parent("ul").css({ display: "block" }).parent("li").parent("ul").css({ display: "block" }).parent("li").addClass("active open");
                }

                else if ($(this).parent("li").parent("ul").parent("li").parent("ul").hasClass("sub-menu")) {
                    $(this).parent("li").parent("ul").parent("ul").parent("li").addClass("active");
                    $(this).parent("li").parent("ul").css({ display: "block" }).parent("li").parent("ul").css({ display: "block" }).parent("li").addClass("active open");
                }
            }
            return;
    ...
    var handleGoTop = function () {
        ...
        jQuery('body').on('click', '.go-top', function (e) {
            App.scrollTo();
            e.preventDefault();
        });
    }
    ...
    var handleNotes = function () {
        jQuery('.note').on('click', '.close-note', function (e) {
            e.preventDefault();
    ...
    return {
        ...
        init: function () {
            ...
            handleNotes(); // handles notes actions

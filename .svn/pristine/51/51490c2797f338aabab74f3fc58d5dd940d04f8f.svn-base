<%@ Page Title="" Language="C#" MasterPageFile="~/NTILU.Master" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="NTILUnion.Membership.Search" %>
            ...
            <div class="col-md-12">
                ...
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li><i class="fa fa-home"></i><a href="/Default.aspx">Home</a> <i class="fa fa-angle-right">
                     ...
                     <li><i class=""></i><a href="Search.aspx">Member Search</a> </li>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box purple">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-cogs"></i>Search Member</div>
                        <div class="tools">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                ...
                                                <asp:DropDownList ID="dropSearchType" runat="server" CssClass="form-control">
                                                    ...
                                                    <asp:ListItem Value="MotherName">MotherName</asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <label class="col-md-2 control-label">

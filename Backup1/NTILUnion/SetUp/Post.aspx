<%@ Page Title="" Language="C#" MasterPageFile="~/NTILU.Master" AutoEventWireup="true"
    CodeBehind="Post.aspx.cs" Inherits="NTILUnion.SetUp.Post" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#<%=txtPost.ClientID %>").rules('add', { required: true, messages: { required: 'Post is required.'} });


            checkFromValidation = function () {
                var bool = true;
                if ($('#<%=txtPost.ClientID %>').valid() == false) bool = false;
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                <h3 class="page-title">
                    Member Post <small>Create Member Post.</small>
                </h3>
        ...
        <div class="row">
            <div class="col-md-12 ">
                ...
                <div class="portlet box purple ">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-reorder"></i>Create Post
                        </div>
                        <div class="tools">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtPost" runat="server" CssClass="form-control" placeholder=" Enter Post Name "></asp:TextBox>
                                        </div>
                                        <label for="<%= txtPost.ClientID%>" class="error" style="display: none">
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <label for="<%= txtDescription.ClientID%>" class="error" style="display: none">
                                        </label>
                                    </div>
                                </div>
		    ...
		    <div class="col-md-12">
			    <div class="portlet box green">
				    <div class="portlet-title">
					    <div class="caption"><i class="fa fa-cogs"></i>Member Post Information</div>
					    <div class="tools">

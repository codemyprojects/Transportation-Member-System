<%@ Page Language="C#" MasterPageFile="~/NTILU.Master" AutoEventWireup="true" CodeBehind="AggregateReport.aspx.cs" Inherits="NTILUnion.Membership.AggregateReport" %>
...
<div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                <h3 class="page-title">
                    Member List <small>List of Aggregate Report</small>
                </h3>
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li><i class="fa fa-home"></i><a href="/Default.aspx">Home</a> <i class="fa fa-angle-right">
                     ...
                     <li><i class=""></i><a href="Search.aspx">Report</a> </li>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box purple">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-cogs"></i>Aggregate Report</div>
                        <div class="tools">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">
                                            By District-Wise:</label>
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-list-ul"></i></span>
                                                <asp:DropDownList ID="dropSearchType" runat="server" CssClass="form-control">
                                                    <asp:ListItem Value="">Select Choice To Aggregate Report</asp:ListItem>
                                                    
                                                    <asp:ListItem Value="Gender">Gender</asp:ListItem>
                                                    <asp:ListItem Value="District">District</asp:ListItem>
                                                    <asp:ListItem Value="FatherName">MembershipYear</asp:ListItem>
                                                    <asp:ListItem Value="Mobile">LicenseType</asp:ListItem>
                                                    <asp:ListItem Value="District">Education</asp:ListItem>

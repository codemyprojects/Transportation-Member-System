...
namespace NTILUnion.Membership
{
    public partial class Membership : System.Web.UI.Page
    {
        ...
        private void Save()
        {
            ...
            {
                string fileExt = (System.IO.Path.GetExtension(fpMemberPhoto.FileName)).ToLower();
                ...
                if (fileExt == ".jpeg" || fileExt == ".jpg")
                {
                    if (fpMemberPhoto.PostedFile.ContentLength <= 1000000)
                    {
...

                        {
                            ...
                            UserDistrict = Session["districtID"].ToString(),
                        ...
                        if (tbl.Rows.Count > 0)
                        {
                            ...
                            uploaderID = tbl.Rows[0]["id"].ToString();
            ...
            Response.Redirect("/membership/fileUploder.aspx?id=" + uploaderID);
        }
        ...
        private void GetMemberList()
        {
            ...
            foreach (DataRow row in tbl.Rows)
            {
                ...
                //string CurrentCity = tbl.Rows[i]["CurrentCity"].ToString();
        ...
        private void GetUnit()
        {
            ...
            if (tbl.Rows.Count > 0)
            {
                ...
                // DropUnit.DataTextField = "Description"
                //DropUnit.DataTextField = "Description";
                DropUnit.DataBind();
            }

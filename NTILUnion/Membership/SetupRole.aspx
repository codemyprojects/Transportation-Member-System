<%@ Page Language="C#" MasterPageFile="~/NTILU.Master" AutoEventWireup="true" CodeBehind="SetupRole.aspx.cs" Inherits="NTILUnion.Membership.SetupRole" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#<%=txtUserRole.ClientID %>").rules('add', { required: true, messages: { required: 'Role is required.'} });
            ...
            checkFromValidation = function () {
                ...
                if ($('#<%=txtUserRole.ClientID %>').valid() == false) bool = false;
            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box green ">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-user"></i>Create Role
                        </div>
                        <div class="tools">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-group">
                                                    ...
                                                    <asp:TextBox ID="txtUserRole" runat="server" CssClass="form-control" placeholder="Enter User Role"></asp:TextBox>
                                                </div>
                                                <label for="<%= txtUserRole.ClientID%>" class="error" style="display: none">
                                                </label>
                                            </div>
                                        </div>

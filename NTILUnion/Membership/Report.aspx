<%@ Page Language="C#" MasterPageFile="~/NTILU.Master" AutoEventWireup="true" CodeBehind="Report.aspx.cs" Inherits="NTILUnion.Membership.Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                <h3 class="page-title">
                    Report <small>Member records are submitted by members to procced membmership
                        process.</small>
                </h3>
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li><i class=""></i><a href="/Membership/MemberVerification.aspx">Report Date Expire</a> </li>
                </ul>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="portlet box purple">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-cogs"></i>Report Date Expire and Date Renew</div>
                        <div class="tools">

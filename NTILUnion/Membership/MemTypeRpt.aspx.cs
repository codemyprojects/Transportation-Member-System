...
namespace NTILUnion.Membership.memberphoto
{
    public partial class MemTypeRpt : System.Web.UI.Page
    {
        ...
        private void MemberSearch(string flag)
        {
            ...
            if (tbl.Rows.Count > 0)
            {
                ...
                sb.AppendLine("<th>Member Type </th>");
                ...
                foreach (DataRow row in tbl.Rows)
                {
                    ...
                    string MemberType = tbl.Rows[i]["District"].ToString();
                    ...
                    sb.AppendLine("<td>" +  MemberType + "</td>");

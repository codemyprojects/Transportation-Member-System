<%@ Page Title="" Language="C#" MasterPageFile="~/NTILU.Master" AutoEventWireup="true" CodeBehind="Education.aspx.cs" Inherits="NTILUnion.SetUp.Education" %>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#<%=txtEducation.ClientID %>").rules('add', { required: true, messages: { required: 'Fiscal Year is required.'} });
        

        checkFromValidation = function () {
            var bool = true;
            if ($('#<%=txtEducation.ClientID %>').valid() == false) bool = false;
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-content">           
		...
		<div class="row">
			<div class="col-md-12">
				<h3 class="page-title">
					Education			<small>Create Education .</small>
				</h3>
		...
		<div class="row">
			<div class="col-md-12 ">
				...
				<div class="portlet box purple ">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-reorder"></i> Create Education Setup
						</div>
						<div class="tools">
                                ...
                                <div class="form-group">
									...
									<div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtEducation" runat="server" CssClass="form-control" placeholder=" Enter Education Level "></asp:TextBox>
                                        </div>
                                        <label for="<%= txtEducation.ClientID%>" class="error"  style="display:none" ></label>
									</div>
								</div>
		    ...
		    <div class="col-md-12">
			    <div class="portlet box green">
				    <div class="portlet-title">
					    <div class="caption"><i class="fa fa-cogs"></i>Education Information</div>
					    <div class="tools">

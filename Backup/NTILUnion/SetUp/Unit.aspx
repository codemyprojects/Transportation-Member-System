<%@ Page Title="" Language="C#" MasterPageFile="~/NTILU.Master" AutoEventWireup="true" CodeBehind="Unit.aspx.cs" Inherits="NTILUnion.SetUp.Unit" %>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#<%=txtUnit.ClientID %>").rules('add', { required: true, messages: { required: 'Unit is required.'} });


        checkFromValidation = function () {
            var bool = true;
            if ($('#<%=txtUnit.ClientID %>').valid() == false) bool = false;
...
<div class="page-content">           
		...
		<div class="row">
			<div class="col-md-12">
				<h3 class="page-title">
					Member Unit			<small>Create Member Unit.</small>
				</h3>
		...
		<div class="row">
			<div class="col-md-12 ">
				...
				<div class="portlet box purple ">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-reorder"></i> Create Unit 
						</div>
						<div class="tools">
                                ...
                                <div class="form-group">
									...
									<div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtUnit" runat="server" CssClass="form-control" placeholder=" Enter Unit "></asp:TextBox>
                                        </div>
                                        <label for="<%= txtUnit.ClientID%>" class="error"  style="display:none" ></label>
									</div>
								</div>
		    ...
		    <div class="col-md-12">
			    <div class="portlet box green">
				    <div class="portlet-title">
					    <div class="caption"><i class="fa fa-cogs"></i>Member Unit Information</div>
					    <div class="tools">

...
{
    public partial class AggreMebershipYearRpt : System.Web.UI.Page
    {
        ...
        private void MemberSearch(string flag)
        {
            ...
            if (tbl.Rows.Count > 0)
            {
                ...
                sb.AppendLine("<th>MembershipYear</th>");
                ...
                foreach (DataRow row in tbl.Rows)
                {
                    ...
                    string MembershipYear = tbl.Rows[i]["MembershipDate"].ToString();
                    ...
                    sb.AppendLine("<td>" + MembershipYear + "</td>");
